...
//	/**
//	 * The dependency is defined as a shape label that directly references another
//	 * shape label through a {@link ShapeExprRef}, without {@link Shape}
//	 * 
//	 * @param rules
//	 * @return
//	 */
...
//			}
//		};
//		DefaultDirectedWeightedGraph<ShapeExprLabel, DefaultWeightedEdge> directShapeReferenceDependency = computeDependencyGraph(
//				rules, directlyReferencedShapeLabelsCollector);
//
//		TarjanSimpleCycles<ShapeExprLabel, DefaultWeightedEdge> tarjan = new TarjanSimpleCycles<>(
//				directShapeReferenceDependency);
...
//	}
//	
//	protected static DefaultDirectedWeightedGraph<ShapeExprLabel, DefaultWeightedEdge> 
// 
