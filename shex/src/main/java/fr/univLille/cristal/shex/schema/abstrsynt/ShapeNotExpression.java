 ...
 *
 */
public class ShapeNotExpression extends AbstractShapeExpression implements ShapeExpression {

	private ShapeExpression subExpression;
	
	public ShapeNotExpression(ShapeExpression subExpression) {
		this.subExpression = subExpression;
	}
	
	public ShapeExpression getSubExpression(){
