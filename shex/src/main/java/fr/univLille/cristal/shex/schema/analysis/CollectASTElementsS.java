 ...
 * @param <C>
 */
public class CollectASTElementsS<C extends ASTElement> extends ShapeExpressionVisitor<Set<C>> {

	private Set<C> set;
	private Predicate<ASTElement> filter;
	private boolean traverseTripleExpressions;

	public CollectASTElementsS (Predicate<ASTElement> filter, Set<C> collectionSet, boolean traverseTripleExpressions) {
	...
	public void visitShape(Shape expr, Object... arguments) {
		...
		if (traverseTripleExpressions) {
			CollectASTElementsT<C> c = new CollectASTElementsT<>(filter,set, traverseTripleExpressions);
