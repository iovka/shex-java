...
import fr.inria.lille.shexjava.schema.FOL.formula.Implication;
import fr.inria.lille.shexjava.schema.FOL.formula.Not;
import fr.inria.lille.shexjava.schema.FOL.formula.OpDiff;
import fr.inria.lille.shexjava.schema.FOL.formula.OpEqual;
import fr.inria.lille.shexjava.schema.FOL.formula.OpEqualInf;
import fr.inria.lille.shexjava.schema.FOL.formula.OpEqualSup;
import fr.inria.lille.shexjava.schema.FOL.formula.OpInf;
import fr.inria.lille.shexjava.schema.FOL.formula.OpSup;
import fr.inria.lille.shexjava.schema.FOL.formula.Operator;
import fr.inria.lille.shexjava.schema.FOL.formula.Or;
import fr.inria.lille.shexjava.schema.FOL.formula.Quantifier;
import fr.inria.lille.shexjava.schema.FOL.formula.Sentence;
import fr.inria.lille.shexjava.schema.FOL.formula.ShapePredicate;
import fr.inria.lille.shexjava.schema.FOL.formula.TriplePredicate;
