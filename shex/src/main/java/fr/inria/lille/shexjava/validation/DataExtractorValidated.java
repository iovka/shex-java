	...
	class VisitorValidatedPart extends ShapeExpressionVisitor<Object> {
		...
		public void visitShape(Shape expr, Object... arguments) {
			...
			if (t.getStatus(currentNode, expr.getId()).equals(Status.NONCONFORMANT)) {
				TripleExpr tripleExpression = sorbeGenerator.getSORBETripleExpr(expr.getTripleExpression());
				...
				PreMatching preMatching = ValidationUtils.computePreMatching(
						currentNode, neighbourhood, constraints, expr.getExtraProperties(),
						ValidationUtils.getPredicateOnlyMatcher(), null);
